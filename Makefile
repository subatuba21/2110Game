...
OFILES = gba.o font.o main.o images/garbage.o images/pacman.o images/pacman-sprite.o images/ghost.o images/dot.o images/trophy.o images/pacmanstart.o images/pacmanstartclosed.o
